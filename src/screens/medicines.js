...
export default class SignUpScreen extends React.Component {
    ...
    upDate = async ()=>{
           ...
           firestore().collection("Medicines").doc().set({
        ...
        }).catch((e) => console.log(e)).then(Alert.alert("Details Uploaded to the Authorities")).then(this.props.navigation.navigate("home"))
    ...
    onChangeText={this.country}>
                        ...
                        <View style={{ flexDirection: 'row', padding: 0, marginBottom: 10, paddingLeft: 10 }}>
                            ...
                            <Picker
                                ...
                                <Picker.Item label="Reporting situation" value="CrReporting situationitical" />
